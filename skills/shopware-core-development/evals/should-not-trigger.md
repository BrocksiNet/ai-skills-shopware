# shopware-core-development — should NOT trigger

- Build a plugin that adds a custom product field. (-> shopware-plugin-development)
- Add a cache tag to my plugin's product loader. (-> shopware-plugin-development)
